...
module.exports = {
	// Métodos de operadores
        ...
        nuevoVuelo: async (req,res,next) => {                   // (POST) Módulo NuevoVuelo: Añade un vuelo a la base de datos
            ...
            const {name, from, to, boarding_time, departure_time, arrival_time, seat, date, gate, passangers} = req.body;
            if (name && from && to && boarding_time && departure_time && arrival_time && seat && date && gate && passangers){
